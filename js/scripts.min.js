...
$(document).ready(function(){$(".preloader").fadeOut(),$(".home-carousel").owlCarousel({loop:!0,dots:!0,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],smartSpeed:900,responsiveClass:!0,startPosition:1,autoplayHoverPause:!0,responsive:{0:{items:1}}}),$(".work-nav ul li").click(function(){$(".work-nav ul li").removeClass("active"),$(this).addClass("active")}),$("#work_gallery").mixItUp(),$(".popup_content").magnificPopup({type:"inline"})});